        ...
        <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
          ...
          <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
            ...
            <Details
              ...
              work="• Facilitated full-cycle consulting engagements for clients and fostering collaboration between 4 cross-functional teams and clients, resulting in acquisition of 2 additional projects.<br />
